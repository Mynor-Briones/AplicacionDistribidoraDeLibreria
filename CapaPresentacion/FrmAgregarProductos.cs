...
namespace CapaPresentacion
{
    ...
    {
        Productos _owner;  // owner = Propietario
     
        public FrmAgregarProducto()
        {
            InitializeComponent();
            //**************************
             //CargarCategorias();       //Fnciona BIEN 
             this.CargarCategorias();  //Fnciona BIEN 
            // Precenta este error: referencia a objeto no establecida como instancia de un objeto
            //**************************
        }

        public FrmAgregarProducto(Productos owner)
        {
            _owner = owner;
            InitializeComponent();            
            //this.CargarCategorias();  No fnciono
            //CargarCategorias(); No fnciono
        ...
        public void FrmAgregarProducto_Load(object sender, EventArgs e)
        {
